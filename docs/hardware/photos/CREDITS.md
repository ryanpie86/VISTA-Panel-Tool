...
Reference photos used in `../green-tx-photo-reference.html`/`.jpg` (physical
parts & wiring identification diagram, a photo-based companion to
`../green-tx-schematic.svg`). Generic/manufacturer reference photos, not
photos of this project's own bench hardware.

| File | Subject | Source | Author | License |
|---|---|---|---|---|
| `rp2040-zero.jpg` | Waveshare RP2040-Zero board | [Waveshare wiki](https://www.waveshare.com/wiki/RP2040-Zero) | Waveshare (manufacturer product photo) | Manufacturer product image, used for part identification |
| `2n2222.jpg` (cropped) | 2N2222A/PN2222A TO-92 pinout | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:2N2222,_PN2222,_and_P2N2222_BJT_Pinout.jpg) | AntonKrugerAtUiowa | CC BY-SA 4.0 |
